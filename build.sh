...
git clone --depth=1 https://gitlab.com/ramadhannangga/irisxe-clang -b iRISxeTC/13.x iRISxe # iRISxe set as Clang Default
...
export KBUILD_COMPILER_STRING="$CLANG_VER (based on LLVM 13.0.0svn)"
